...
class eye:
    ...
    def search(self):
        ...
        if self.spec=="Гендзюцу" and self.color=="Красный" and self.tier==1:
            ...
            tomoe=PhotoImage(file='c:\\Users\\user\\Desktop\\Paper\\cdSftng\\pthn\\eyeFndr\\shrngn.png')
            ...
            ktsrygn=PhotoImage(file='c:\\Users\\user\\Desktop\\Paper\\cdSftng\\pthn\\eyeFndr\\ktsrygn.png')
            ...
            rnngn=PhotoImage(file='c:\\Users\\user\\Desktop\\Paper\\cdSftng\\pthn\\eyeFndr\\rnngn.png')
            ...
            kkgn=PhotoImage(file='c:\\Users\\user\\Desktop\\Paper\\cdSftng\\pthn\\eyeFndr\\kkgn.png')
            ...
            bykgn=PhotoImage(file='c:\\Users\\user\\Desktop\\Paper\\cdSftng\\pthn\\eyeFndr\\bykgn.png')
            ...
            tnsgn=PhotoImage(file='c:\\Users\\user\\Desktop\\Paper\\cdSftng\\pthn\\eyeFndr\\tnsgn.png')
